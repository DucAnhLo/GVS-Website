    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-white">
        ...
        <div className="border-b border-gray-200 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="flex items-center gap-2 text-xs font-medium uppercase tracking-widest text-gray-700">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-20 pb-32">
          ...
          <div className="mb-16">
            <div className="mb-6">
              <div className="inline-block px-4 py-2 mb-6 text-xs font-semibold uppercase tracking-widest text-white" style={{ backgroundColor: accent }}>
                {caseStudy.client}
              </div>
            </div>
            <h1 className="text-4xl lg:text-5xl font-semibold text-gray-900 leading-tight mb-6 max-w-4xl">
              {title}
            </h1>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-8">
                <div className="relative group">
                  ...
                  <div className="absolute top-6 right-6 px-4 py-2 bg-white/95 backdrop-blur-sm shadow-lg">
                    <div className="text-xs font-semibold uppercase tracking-wider text-gray-900">Live Platform</div>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-gray-50 p-8 border-l-4" style={{ borderColor: accent }}>
                <h3 className="text-xs font-semibold uppercase tracking-widest text-gray-700 mb-6">Project Overview</h3>
                <div className="space-y-6">
                  <div>
                    <div className="text-sm text-gray-500 mb-1">Client</div>
                    <div className="text-xl font-semibold text-gray-900">{caseStudy.client}</div>
                  </div>
                  <div className="border-t border-gray-200 pt-6">
                    <div className="text-sm text-gray-500 mb-1">Timeline</div>
                    <div className="text-xl font-semibold text-gray-900">{caseStudy.duration}</div>
                  </div>
                  <div className="border-t border-gray-200 pt-6">
                    <div className="text-sm text-gray-500 mb-1">Launch Year</div>
                    <div className="text-xl font-semibold text-gray-900">{year}</div>
                  </div>
                </div>
              </div>
              ...
              {liveUrl && liveUrl !== "#" && (
                <a
                  ...
                  className="block w-full text-center px-8 py-5 font-semibold text-sm uppercase tracking-wider transition-all group text-white shadow-lg hover:shadow-2xl"
              ...
              {/* Technology Tags */}
              <div>
                <div className="text-xs font-semibold uppercase tracking-widest text-gray-700 mb-4">Tech Stack</div>
                <div className="flex flex-wrap gap-2">
                  {tech.slice(0, 4).map((technology, index) => (
                    <span
                      key={index}
                      className="px-3 py-1.5 text-xs font-medium bg-white border-2 border-gray-900 text-gray-900 uppercase tracking-wider"
                    >
                      {technology}
                    </span>
                  ))}
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="flex items-center gap-6 mb-12">
            <div className="w-16 h-16 bg-red-100 flex items-center justify-center">
              <span className="text-3xl font-semibold text-red-600">01</span>
            </div>
            <div>
              <div className="text-sm font-medium text-red-600 uppercase tracking-widest mb-1">The Problem</div>
              <h2 className="text-4xl font-semibold text-gray-900">The Old System Was Failing</h2>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="flex items-center gap-6 mb-12">
            <div className="w-16 h-16 flex items-center justify-center" style={{ backgroundColor: accent + '20' }}>
              <span className="text-3xl font-semibold" style={{ color: accent }}>02</span>
            </div>
            <div>
              <div className="text-sm font-medium uppercase tracking-widest mb-1" style={{ color: accent }}>Our Approach</div>
              <h2 className="text-4xl font-semibold text-gray-900">How We Rebuilt Everything</h2>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex items-center gap-6 mb-16">
              <div className="w-16 h-16 bg-white/10 flex items-center justify-center">
                <span className="text-3xl font-semibold" style={{ color: accent }}>03</span>
              </div>
              <div>
                <div className="text-sm font-medium uppercase tracking-widest mb-1" style={{ color: accent }}>The Transformation</div>
                <h2 className="text-5xl font-semibold">Night & Day Difference</h2>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <h3 className="text-3xl font-semibold">Before</h3>
                  </div>
                </div>
      ...
      {caseStudy.screenshots && (
        <section className="relative py-32 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex items-center gap-6 mb-16">
              <div className="w-16 h-16 flex items-center justify-center" style={{ backgroundColor: accent + '20' }}>
                <span className="text-3xl font-semibold" style={{ color: accent }}>04</span>
              </div>
              <div>
                <div className="text-sm font-medium uppercase tracking-widest mb-1" style={{ color: accent }}>Visual Showcase</div>
                <h2 className="text-5xl font-semibold text-gray-900">See It In Action</h2>
              </div>
            </div>
            ...
            <div className="mb-8">
              <div className="relative group overflow-hidden bg-gray-900">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-gray-900 to-transparent p-8">
                  <h3 className="text-2xl font-semibold text-white mb-2">{caseStudy.screenshots[0].title}</h3>
            ...
            {liveUrl && liveUrl !== "#" && (
              <div className="mt-12 text-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 px-10 py-4 bg-gray-900 text-white font-semibold text-sm uppercase tracking-wider hover:bg-gray-800 transition-all group"
                >
                  <Icon icon="fluent:globe-24-filled" className="w-5 h-5" />
      ...
      <section className="relative py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center gap-6 mb-16">
            <div className="w-16 h-16 flex items-center justify-center" style={{ backgroundColor: accent + '20' }}>
              <span className="text-3xl font-semibold" style={{ color: accent }}>05</span>
            </div>
            <div>
              <div className="text-sm font-medium uppercase tracking-widest mb-1" style={{ color: accent }}>What We Built</div>
              <h2 className="text-5xl font-semibold text-gray-900">Powerful Features</h2>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center gap-6 mb-16">
            <div className="w-16 h-16 bg-white/20 flex items-center justify-center">
              <span className="text-3xl font-semibold text-white">06</span>
            </div>
            <div>
              <div className="text-sm font-medium text-white/80 uppercase tracking-widest mb-1">The Impact</div>
              <h2 className="text-5xl font-semibold text-white">Real Results</h2>
            </div>
          </div>
      ...
      {caseStudy.technologies && (
        <section className="relative py-32 bg-gray-900 text-white">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex items-center gap-6 mb-16">
              <div className="w-16 h-16 bg-white/10 flex items-center justify-center">
                <span className="text-3xl font-semibold" style={{ color: accent }}>07</span>
              </div>
              <div>
                <div className="text-sm font-medium uppercase tracking-widest mb-1" style={{ color: accent }}>Built With</div>
                <h2 className="text-5xl font-semibold">Modern Tech Stack</h2>
              </div>
            </div>
      ...
      <section className="relative py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="px-12 py-5 bg-gray-900 text-white font-semibold text-sm uppercase tracking-wider hover:bg-gray-800 transition-all inline-flex items-center justify-center gap-3 group"
            >
              Start Your Project
              <Icon icon="fluent:arrow-right-24-filled" className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link
              href="/#projects"
              className="px-12 py-5 border-2 border-gray-900 text-gray-900 font-semibold text-sm uppercase tracking-wider hover:bg-gray-50 transition-all inline-flex items-center justify-center gap-3"
            >
              View More Work
