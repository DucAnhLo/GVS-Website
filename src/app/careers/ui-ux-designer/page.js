    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-medium text-gray-900 mb-4">About the Role</h2>
        ...
        {/* Responsibilities */}
        <section className="mb-8">
          <h2 className="text-2xl font-medium text-gray-900 mb-4">Key Responsibilities</h2>
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              <span className="text-azure-blue font-medium flex-shrink-0">•</span>
        ...
        {/* Requirements */}
        <section className="mb-8">
          <h2 className="text-2xl font-medium text-gray-900 mb-4">Requirements</h2>
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              <span className="text-azure-blue font-medium flex-shrink-0">•</span>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-medium text-gray-900 mb-4">Preferred Qualifications</h2>
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              <span className="text-azure-cloud font-medium flex-shrink-0">+</span>
        ...
        <section className="mt-12 pt-6 border-t-2 border-gray-200">
          <h2 className="text-2xl font-medium text-gray-900 mb-4">How to Apply</h2>
