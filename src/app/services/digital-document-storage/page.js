          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="space-y-4">
                <div className="inline-block px-6 py-3 border-2 border-pink-600 text-pink-600 font-black text-sm tracking-widest" style={{ animation: 'fadeInLeft 0.8s ease-out 0.1s both' }}>
                  DOCUMENT STORAGE
                </div>
              ...
              <div className="flex flex-wrap gap-4" style={{ animation: 'fadeInLeft 0.8s ease-out 0.4s both' }}>
                <Link href="/contact" className="group relative px-8 py-4 bg-gradient-to-r from-pink-600 to-rose-600 text-white font-black text-sm tracking-wider overflow-hidden">
      ...
      <section className="relative py-32 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <div className="inline-block px-6 py-3 border-2 border-pink-600 text-pink-600 font-black text-sm tracking-widest mb-6">
              TECHNOLOGY STACK
            </div>
