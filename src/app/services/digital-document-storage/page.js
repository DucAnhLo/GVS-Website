          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="flex flex-wrap gap-4" style={{ animation: 'fadeInLeft 0.8s ease-out 0.4s both' }}>
                <Link href="/contact" className="group relative px-8 py-4 bg-gradient-to-r from-pink-600 to-rose-600 text-white font-semibold text-sm tracking-wider overflow-hidden">
...
{/* 
      ...
      {/* CTA Section */}
      <section className="relative py-32 px-6 bg-gradient-to-r from-pink-600 via-rose-600 to-red-600 text-white">
